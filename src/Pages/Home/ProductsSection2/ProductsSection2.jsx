        ...
        <>
            ...
            <section className="ps2-section">
                <div className="ps2-header">
                    <h2 className="ps2-title">Products</h2>

                    <div className="ps2-arrows">
                        <button className="ps2-arrow ps2-prev" aria-label="Previous">
                            <BsArrowLeft />
                        </button>
                        <button className="ps2-arrow ps2-next" aria-label="Next">
                            <BsArrowRight />
                        </button>
                    </div>
                </div>

                <div className="ps2-slider-wrap">
                    {isLoading ? (
                        <div className="ps2-loading">
                            <div className="ps2-spinner"></div>
                            <p>Loading products...</p>
                        </div>
                    ) : error ? (
                        <div className="ps2-error">
                            <p>{error}</p>
                            ...
                            {products.map((product) => {
                                ...
                                return (
                                    <SwiperSlide key={product.productId}>
                                        ...
                                        >
                                            <div className="ps2-img-wrap">
                                                {priceInfo.hasOffer && (
                                                    <span className="ps2-offer-badge">
                                                        {priceInfo.offerLabel}
                                                    </span>
                                                )}

                                                <button
                                                    className={`ps2-wish-btn${isWishlisted ? " ps2-wish-active" : ""}`}
                                                ...
                                                >
                                                    {isUpdating ? (
                                                        <span className="ps2-wish-spinner"></span>
                                                    ) : isWishlisted ? (
                                                        <FaHeart />
                                                    ) : (
                                                        <FaRegHeart />
                                            ...
                                            <div className="ps2-info">
                                                <h3 className="ps2-name">{product.productName}</h3>

                                                <div className="ps2-prices">
                                                    <span className="ps2-price">
                                                        ₹{formatCurrency(priceInfo.finalPrice)}
                                                    </span>
                                                    {priceInfo.originalPrice > priceInfo.finalPrice && (
                                                        <>
                                                            <span className="ps2-original">
                                                                ₹{formatCurrency(priceInfo.originalPrice)}
                                                            </span>
                                                            {priceInfo.discount > 0 && (
                                                                <span className="ps2-discount">
