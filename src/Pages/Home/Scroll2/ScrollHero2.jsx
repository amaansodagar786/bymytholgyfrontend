...
import "./ScrollHero2.scss";

// CHANGE THIS IMAGE URL to your desired background image
const heroBg2 =
...
const ScrollHero2 = () => {
    ...
    return (
        <section className="sh2-section" ref={sectionRef}>
            <div className="sh2-bg" style={{ backgroundImage: `url(${heroBg2})` }} />

            <div className="sh2-content" ref={textRef}>
                <span className="sh2-collection-label">Exclusive</span>
                <h1 className="sh2-brand">Premium Audio</h1>
                <p className="sh2-tagline">Experience Sound Like Never Before</p>
                <button
                    className="sh2-cta"
                    ref={btnRef}
